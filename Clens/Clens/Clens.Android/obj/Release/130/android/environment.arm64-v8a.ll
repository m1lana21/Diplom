...
@__app_environment_variables_v_2.5 = internal constant [37 x i8] c"5a4761fd-94f6-4fed-a95f-e72f9d7a66b4\00", align 1
...
@__ApplicationConfig_android_package_name.0 = internal constant [22 x i8] c"com.companyname.Clens\00", align 1
...
@application_config = local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 33555392, ; android_runtime_jnienv_class_token
	i32 100674577, ; jnienv_initialize_method_token
	i32 100674576, ; jnienv_registerjninatives_method_token
...
@assembly_store_bundled_assemblies = local_unnamed_addr global [107 x %struct.AssemblyStoreSingleAssemblyRuntimeData] zeroinitializer, align 8
